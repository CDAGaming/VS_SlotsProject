' Name:         Slots Project - FINAL - 5 Slot Game
...
Public Class FrmGame_5Slots
    ...
    Private Sub TmrWinCheck_Tick(sender As Object, e As EventArgs) Handles tmrWinCheck.Tick
        If intNum1 = intNum2 AndAlso intNum1 = intNum3 AndAlso intNum1 = intNum4 AndAlso intNum1 = intNum5 Then
    ...
    Private Sub FrmGame_5Slots_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub FrmGame_5Slots_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        My.Settings.Save()
    End Sub
End Class